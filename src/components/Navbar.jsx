...
const Navbar = ({darkMode, toggleDarkMode}) => {
  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
        ...
        className={`flex items-center justify-center ${colors.navBg} backdrop-blur-lg rounded-2xl pxx-4 lg:px-8 py-2 shados-lg`}>
            <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
                ...
                className="flex items-center space-x-2">
                    <span className={`text-xl fot-bold ${colors.textPrimary}`}>
                ...
                <div className=" hidden lg:flex items-center space-x-6">
                    {navItems.map((item)=>(
                        ...
                        className="relative">
                            <motion.span
                            className={`font-meduim transition-colors duration-300 ${
                            ...
                            {activeSection=== item.name.toLowerCase() &&(
                                ...
                                rigt-0 h-0.5 bg-linear-to-r rounded-full
                                ${colors.indicator}`}>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    aria-label={darkMode
                        ...
                        {darkMode ? (
                            <Sun className="w-5 f-5 text-yellow-300"/>
                        ):(
